...
export const projects: Project[] = [
  ...
  },
  {
    id: "rcs-app",
    title: "RCS",
    subtitle: "Street Video Analysis",
    description:
      "Ingest road video from S3, run object detection (garbage, illegal parking, pedestrians), overlay it on a map with SRT timing.",
    role: "Full Stack Engineer",
    technologies: ["NestJS", "React", "Vite", "Leaflet", "AWS S3"],
    features: [
      "S3 folder ingest",
      "Object detection pipeline",
      "Map overlay with SRT",
    ],
    challenges: [
      "Video is huge. Don't process it on the request thread.",
      "Detections have to line up with the map, not float in space.",
    ],
    responsibilities: [
      "Nest ingest/API and React + Leaflet UI.",
      "S3 pipeline with the rest of the team.",
    ],
    impact: [
      "Reviewers can scrub a run and see what the model flagged.",
    ],
    category: "platform",
    screenshots: [],
  },
  {
    id: "mobile-expert",
    title: "Mobile Expert",
    subtitle: "T-Mobile Plan RAG Chat",
    description:
      "Crawls T-Mobile plan pages, embeds them, answers questions with LangGraph/GPT-4. A research prototype, not a carrier product.",
    role: "Full Stack Engineer",
    technologies: ["FastAPI", "LangChain", "LangGraph", "OpenAI", "Selenium", "React", "Vite", "Tailwind CSS"],
    features: [
      "Selenium crawl of plan pages",
      "Vector search + LangGraph Q&A",
      "Simple React chat UI",
    ],
    challenges: [
      "Carrier pages change weekly. The crawl has to be boring and retry-friendly.",
      "Answers that cite the page, not a vibe.",
    ],
    responsibilities: [
    ...
    impact: [
      "A working Q&A path over live plan content.",
    ],
    category: "platform",
    screenshots: [],
  },
  {
    ...
    subtitle: "Workplace Design Voting",
    description:
      "Legacy Django/Vue app (old Skyline). Customers vote on office layouts, billboards, buildings. I keep it alive and add what they still need.",
    role: "Full Stack Engineer",
    technologies: ["Django", "MySQL", "Vue.js", "Webpack"],
    features: [
      "Design voting / surveys",
      "Scenario calculator",
      "Customer-facing campaigns",
    ],
    challenges: [
      "Django 2.2. You don't rewrite it for fun. You patch carefully.",
    ],
    responsibilities: [
      "Feature work and fixes on the monolith.",
      "Keep deploys from surprising anyone.",
    ],
    impact: [
      "The product still runs campaigns without a full rewrite.",
    ],
    category: "enterprise",
    screenshots: [],
  },
